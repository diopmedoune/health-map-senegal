...
const Register: React.FC = () => {
  ...
  const roles = [
    { 
      ...
      description: 'Rechercher et noter des établissements'
    },
    { 
      value: 'TUTEUR', 
      label: 'Tuteur d\'établissement',
      description: 'Gérer un établissement de santé'
    },
    { 
      value: 'ADMIN', 
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-gray-900">
            Inscription à HealthMap Senegal
          </h2>
